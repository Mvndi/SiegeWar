...
public enum ConfigNodes {
	...
	SIEGE_DURATION_PILLAGE(
			...
			"10",
			"",
			"# The default duration of a pillage, in minutes",
			"# It will be multiply by attacker kill ratio.",
			"# The default value is 10."),
	SIEGE_MIN_DURATION_CANCELS_PILLAGE(
			"war.siege.times.min_duration_cancels_pillage",
			"true",
			"",
	...
	SIEGE_MIN_DURATION_PILLAGE(
			...
			"5",
			"",
			"# The min duration of a pillage, in minutes.",
			"# If pillage time is lower there will be either raised or there will no pillage.",
			"# The default value is 5."),
	SIEGE_MAX_DURATION_PILLAGE(
			"war.siege.times.max_duration_pillage",
			"15",
			"",
			"# The max duration of a pillage, in minutes.",
			"# If pillage time is higher, it will be lowered to that value.",
